...
Status: **shipped** (2026-09-18, PR #237 + #239 → v0.2.1145 프리뷰; 실측 = `reaction-ui/loop.md` R1·R2) · 기준 커밋 main `3229521d` · 유저 원문 = [`reaction-ui/ssot.md`](reaction-ui/ssot.md) · 선행 계약 = [`06-user-steering-spec.md`](06-user-steering-spec.md)
