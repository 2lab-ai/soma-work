  ...
  "choices": [
    {
      ...
      "options": [
        {"id": "1", "label": "PROJ-1913 출금 거절 버그 분석", "description": "projalpha 백엔드 소스를 분석하여 출금 거절 API 버그 원인 파악"},
        {"id": "2", "label": "PROJ-1654 홀덤 행 추가", "description": "projbeta + projalpha에서 게임별 성과분석에 홀덤 추가"}
      ],
    ...
    },
    {
      ...
      "options": [
        {"id": "3", "label": "PROJ-1895 입금 처리 개선 구현", "description": "crypto_wallet_transaction 검출 시점에 user_wallet_transaction 선행 생성"}
      ],
  ...
  "choices": [
    {
      ...
      "options": [
        { "id": "1", "label": "PROJ-1913 상세 확인", "description": "출금 거절 버그" },
        { "id": "2", "label": "PROJ-1977 구현 시작", "description": "수수료 비율 처리" }
      ],
