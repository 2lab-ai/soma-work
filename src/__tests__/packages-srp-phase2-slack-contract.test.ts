...
describe('packages-srp Phase 2 slack contract', () => {
  it('@soma/slack owns Slack leaf UI helpers with legacy src shims', () => {
    ...
    expect(manifest.exports).toMatchObject({
      ...
      './pipeline/stream-executor-cleanup-helpers': './dist/pipeline/stream-executor-cleanup-helpers.js',
    ...
    const movedModules = [
      ...
      'pipeline/stream-executor-cleanup-helpers',
