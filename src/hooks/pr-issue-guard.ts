 ...
 * Lowercase keys (`PROJ-4217`) are NOT valid Jira keys and indicate a
 ...
 * `Closes PROJ-4217` (user-typed lowercase) is detected and compared against
 ...
 * (e.g. `Related: PROJ-4217` without `Closes` and without a URL) are
