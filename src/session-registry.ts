...
export class SessionRegistry {
   ...
   * Trace: docs/current/plans/cron-scheduler/trace.md, Scenario 5, Section 3b-3c
   */
  ...
  setActivityState(channelId: string, threadTs: string | undefined, state: ActivityState): void {
    ...
    if (state === 'idle') {
      ...
      // Trace: docs/current/plans/cron-scheduler/trace.md, Scenario 5, Section 3b
   ...
   * Trace: docs/current/plans/cron-scheduler/trace.md, Scenario 5, Section 3c
   */
