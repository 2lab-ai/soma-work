---
description: "DEPRECATED - Use /oracle-reviewer command instead (Claude Code #13605: custom agents cannot access MCP tools)"
model: haiku
tools: []
color: "#888888"
---
...
Do NOT proceed. Tell the caller to use `/oracle-reviewer` command.
