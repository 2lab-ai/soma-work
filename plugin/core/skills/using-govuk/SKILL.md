---
name: using-govuk
description: Write and edit in GOV.UK / GDS house style — plain English, active voice, front-loaded content, sentence case, and no bold or italics for emphasis. Use when writing or editing reports, research write-ups, guidance, documentation, summaries, or any prose where clarity and accessibility matter. Triggers on "govuk style", "gov.uk style", "plain english", "gds style", "rewrite in plain english".
---

# using-govuk — GOV.UK / GDS house style
...
Adapted from the GOV.UK style guide and GDS content design principles. Source: https://gist.github.com/fofr/505e225f9bf5e839d30c12ba6bfa0be2
