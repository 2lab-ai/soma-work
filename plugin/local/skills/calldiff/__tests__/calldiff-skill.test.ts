 ...
 *
 *  - T1: plugin/local/skills/calldiff/SKILL.md exists as a complete plugin skill
...
const DEFAULT_PROMPT = resolve(__dirname, '..', '..', '..', '..', '..', 'src', 'prompt', 'default.prompt');
...
describe('plugin manifest keeps pace with its payload (plugin/local/CLAUDE.md rule)', () => {
