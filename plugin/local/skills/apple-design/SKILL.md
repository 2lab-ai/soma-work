...
Vendored from [`emilkowalski/skills`](https://github.com/emilkowalski/skills) (MIT); see [`LICENSES/NOTICE.md`](./LICENSES/NOTICE.md) for attribution. Pairs with the local `motion-design` (exact curves/durations) and `review-motion` (reviewer) skills.
