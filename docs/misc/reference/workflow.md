...
```
 User: "@제갈량 https://atlassian.net/browse/PROJ-123"
 │
 ▼
┌──────────────────────────────────────────────────────────────┐
│ Dispatch (Haiku 4.5)                                         │
│ → { "workflow": "jira-brainstorming", "title": "PROJ-123...", │
│     "links": { "issue": "https://...PROJ-123" } }            │
└───────────────────────┬──────────────────────────────────────┘
                        │
                        ▼
┌──────────────────────────────────────────────────────────────┐
...
│  │ • git checkout -b feature/PROJ-123-short-desc          │    │
