...
- Slack UI 액션 패널 스펙: `docs/current/spec/13-slack-ui-action-panel.md`
- `/z` 슬래시 커맨드 마스터 스펙: `docs/current/spec/z-command-master-spec.md` (§8 Block Kit, §15 actions/view id)
