...
See [`docs/archive/features/slack-ui/phase0.md` § Streaming mode invariant](./phase0.md#streaming-mode-invariant).
...
| `docs/archive/features/slack-ui/phase1.md` | This document |
