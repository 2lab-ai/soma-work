...
> Debug trace: `docs/misc/debugging/current/issue64-202603250015/trace.md`
...
→ Proceed with Vertical Trace via `stv:trace docs/archive/features/issue64-midthread-fix-v2/spec.md`
