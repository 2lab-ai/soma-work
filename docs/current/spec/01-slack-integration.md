...
2. `git revert` + 재배포.
3. `docs/archive/manifests/slack-app-manifest.prev.json` + `scripts/slack-manifest-rollback.sh` — Slack 앱 설정 UI에서 `/z` 슬래시 커맨드 제거.

상세: `docs/runbook/rollback-z-refactor.md`.
