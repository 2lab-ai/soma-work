...
> STV Trace | Created: 2026-04-27 | Spec: docs/current/plans/dedup-744-pr1/spec.md
...
→ `stv:work docs/current/plans/dedup-744-pr1/trace.md`로 시나리오별 구현 (zwork phase2가 호출).
