...
- Example: `Co-Authored-By: {{user.displayName}} <{{user.email}}>` → `Co-Authored-By: Zhuge <z@yourcompany.io>`
...
### 5. Verification
- After S2 substitution, templates should read: `Co-Authored-By: Zhuge <z@yourcompany.io>`
