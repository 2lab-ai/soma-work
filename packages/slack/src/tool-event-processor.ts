...
export interface McpCallTracker {
  ...
  getToolStats(serverName: string, toolName: string): McpCallStats | null | undefined;
}
...
const noopMcpCallTracker: McpCallTracker = {
  startCall: () => '',
  endCall: () => null,
  getElapsedTime: () => null,
  getToolStats: () => null,
...
export function setToolEventProcessorProviders(providers: ToolEventProcessorProviders): void {
...
export class ToolEventProcessor {
  ...
  constructor(
    ...
    mcpCallTrackerInstance: McpCallTracker = toolEventProcessorProviders.getDefaultMcpCallTracker(),
