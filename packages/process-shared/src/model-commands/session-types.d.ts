 ...
 */
export type WorkflowType = 'onboarding' | 'jira-executive-summary' | 'jira-brainstorming' | 'jira-planning' | 'jira-create-pr' | 'pr-review' | 'pr-fix-and-update' | 'pr-docs-confluence' | 'deploy' | 'default';
/**
 * Renew command state
 */
...
export type SessionResourceOperation = SessionResourceAddOperation | SessionResourceRemoveOperation | SessionResourceSetActiveOperation;
/**
...
export type SessionInstructionOperation = SessionInstructionAddOperation | SessionInstructionRemoveOperation | SessionInstructionClearOperation;
