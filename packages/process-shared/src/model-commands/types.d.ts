import type { Continuation, RenewState, SaveContextResultPayload, SessionResourceSnapshot, SessionResourceUpdateRequest, UserChoice, UserChoices, WorkflowType } from './session-types';
export type ModelCommandId = 'GET_SESSION' | 'UPDATE_SESSION' | 'ASK_USER_QUESTION' | 'CONTINUE_SESSION' | 'SAVE_CONTEXT_RESULT' | 'SAVE_MEMORY' | 'GET_MEMORY' | 'MANAGE_SKILL' | 'RATE';
